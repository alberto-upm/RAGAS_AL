...
class TestsetGenerator:
    ...
    def generate(
        ...
        if self.persona_list is None:
            ...
            # Normalizamos los nombres para que solo contengan la parte antes del paréntesis (si existe)
            for persona in self.persona_list:
                persona.name = persona.name.split(" (")[0].strip()
        ...
        print("Escenarios Generados:", [scenario_sample_list])
